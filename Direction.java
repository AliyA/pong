 ...
 * of a direction may be obtained by using either the getDegrees() method or the
 * getRadians() method. The angle is measured anti-clockwise from the East
 * direction . For example, 0 degrees indicates a direction of East, 90 degrees
 * indicates North,
 * <p>
...
public class Direction {
	 ...
	 * 
	 * @param degrees
	 *            the angle of this direction, specified in degrees.
	 */
	...
	/**
	 * Calculates the modulus of number/divisor using floating-point arithmetic.
	 * 
	 * @param number
	 *            the number to divide
	 * @param divisor
	 *            the size of divisions
	...
	/**
	 * Returns a new direction object that points 90 degrees to the left of this
	 * one.
	 * 
	 ...
	 * 
	 * @param degrees
	 *            specifies how many degrees should be added to produce the new
	 *            direction.
