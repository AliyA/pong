...
public class Paddle
{
     ...
     * with. Then, if the last item has been cleared, the game is moved into
     * the Game.State.WON state. If the player has come into contact with a
     * monster, the game is moved into the Game.State.LOST state.
     */
